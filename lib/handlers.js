...
// Dashboard (view all checks)
handlers.checksList3 = function (data, callback) {
    // Reject any request that isn't a GET
    if (data.method === 'get') {
        // Prepare data for interpolation
        var templateData = {
        ...
        // Read in a template as a string
        helpers.getTemplate('checksList3', templateData, function (err, str) {
            if (!err && str) {
                // Add the universal header and footer
                helpers.addUniversalTemplates3(str, templateData, function (err, str) {
                    if (!err && str) {
                        // Return that page as HTML
                        callback(200, str, 'html');
                    } else {
...
// Dashboard (view all checks)
handlers.checksList2 = function (data, callback) {
    // Reject any request that isn't a GET
    if (data.method === 'get') {
        // Prepare data for interpolation
        var templateData = {
        ...
        // Read in a template as a string
        helpers.getTemplate('checksList2', templateData, function (err, str) {
            if (!err && str) {
                // Add the universal header and footer
                helpers.addUniversalTemplates2(str, templateData, function (err, str) {
                    if (!err && str) {
                        // Return that page as HTML
                        callback(200, str, 'html');
                    } else {
